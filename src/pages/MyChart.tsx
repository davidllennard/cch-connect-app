    ...
    <div className="container page-container">
      ...
      <div className="feature-grid">
        ...
        <FeatureTile
          ...
          onClick={() => alert("Medications section coming soon")}
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        <FeatureTile
          ...
          onClick={() => alert("Messages section coming soon")}
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
        ...
        <FeatureTile
          title="Billing"
          description="View and pay medical bills"
          onClick={() => alert("Billing section coming soon")}
          icon={
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
